...
class FetcherTests(unittest.TestCase):
    ...
    def test_fetch_all_users_merges_all_pages(self):
        ...
        self.assertNotIn("content", result["data"]["pages"][0])
        self.assertEqual(result["data"]["pages"][0]["contentCount"], 2)
        self.assertEqual(result["data"]["pages"][0]["pageNumber"], 1)
        self.assertNotIn("content", result["data"]["pages"][1])
        self.assertEqual(result["data"]["pages"][1]["contentCount"], 1)
    ...
    def test_fetch_all_users_fetches_all_paged_records_for_each_user(self):
        ...
        self.assertNotIn("content", users[0]["pagedRecords"]["pages"][0])
        self.assertEqual(users[0]["pagedRecords"]["pages"][0]["contentCount"], 2)
        self.assertEqual(users[0]["pagedRecords"]["pages"][0]["pageNumber"], 1)
        self.assertNotIn("content", users[0]["pagedRecords"]["pages"][1])
        self.assertEqual(users[0]["pagedRecords"]["pages"][1]["contentCount"], 1)
        ...
        self.assertNotIn("content", users[1]["pagedRecords"]["pages"][0])
        self.assertEqual(users[1]["pagedRecords"]["pages"][0]["contentCount"], 1)
